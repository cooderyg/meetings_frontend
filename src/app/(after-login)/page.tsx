      ...
      <main className="flex flex-col h-screen max-h-screen ">
         {tab === undefined && (
            <section className="flex flex-col justify-center items-center min-h-[200px] w-full">
               <h1 className="font-bold text-2xl text-slate-950">👋 안녕하세요. 오늘도 새로운 기록을 시작해볼까요?</h1>
               <Link
                  href="space/meeting"
         ...
         {tab === 'drafts' && <h1 className="py-3 px-6 font-bold text-2xl text-slate-950">초안</h1>}

         {tab === 'shared' && <h1 className="py-3 px-6 font-bold text-2xl text-slate-950">공유 받은 노트</h1>}
